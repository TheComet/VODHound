 ...
 * @return Returns VH_VEC_OOM on failure, VH_OK on success.
 */
VH_PUBLIC_API int
 ...
 * @return Returns VH_OK if the data was successfully pushed, VH_VEC_OOM
 * if otherwise.
 */
VH_PUBLIC_API int
 ...
 * VH_VEC_FOR_EACH(some_vector, bar, element)
 * {
