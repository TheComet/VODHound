...
struct rf_db_interface
{
	...
	/* Static tables */
	int (*motion_add)(struct rf_db* db, uint64_t hash40, struct rf_str_view label);
	...
	int (*sponsor_add_or_get)(struct rf_db* db, struct rf_str_view short_name, struct rf_str_view name, struct rf_str_view website);
