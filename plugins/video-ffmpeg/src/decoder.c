...
int decoder_open_file(struct decoder* decoder, const char* file_name, int pause)
{ 
...
int video_is_open(struct plugin_data* plugin)
{
    return 0;
}
...
uint64_t video_offset(struct plugin_data* plugin, int num, int den)
{
    return 0;
}

uint64_t video_duration(struct plugin_data* plugin, int num, int den)
{
    return 0;
}
int video_is_playing(struct plugin_data* plugin)
{
    return 0;
}
...
int video_volume(struct plugin_data* plugin)
{
    return 0;
}
